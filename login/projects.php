...
// ********************************************database connection *****************************************************  
  ...
  // ****************************************database access*************************************     
       ...
       $sql = "SELECT * from predictive order by id";     // access sql      
 ...
 echo "<table border='1'>";
 echo "<tr><th>ID</th><th>TEMPERATURE</th><th>HUMIDITY</th><th>VIBRATION</th><th>RECORD HISTORY</th></tr>";
 while ($row = mysqli_fetch_assoc($retval)) {
     ...
     echo "<td><button onclick=\"window.open('{$row['URL']}', '_blank')\">Click</button></td>";
     echo "</tr>";
 }
 echo "</table>";        
        mysqli_close($conn);
...
?> 
<Center><a class="btn-success" href="../KEY_UPDATE.php" target="_blank">Update Secret Key</a></center> 
                    </div>
                  <!-- body -->
                </div>
            </div>
